...
To start, let's take a peek at my lipid profile from March 12th, 2021.
...
- VLDL: very low density aka very full of lipids
...
You can eat cholesterol containing foods & that cholesterol will eventually make it to your blood stream where it will be used to build & repair cells. But if you don't eat much cholesterol, your liver will manufacture it from carbs & use that instead. As a result, your diet has very little effect on the amount of cholesterol in your blood.
...
Now that we have a basic understanding of the actors in this play, we can more clearly discuss heart disease & the role lipids play.
...
These plaques are formed from white blood cells that detect & eat dangerous oxidized lipoproteins. For example: you smoke a cigarette & the oxidative stress damages LDL particles which your immune system attacks & temporarily attaches to the walls of your artery. Later, an HDL particle swings by and picks up some of these stagnant lipids to help clean up. In healthy people, it's normal for small fatty streaks to continuously form & disappear from the walls of their arteries.

Problems arise when plaque forms more quickly than it can be cleaned up. As fat-filled white blood cells (aka foam cells) accumulate, the plaque grows in size. This triggers your artery to grow, ensuring blood flow doesn't get cut off. However, this plaque is hard & inflexible so the artery ends up becoming stiff. At some point later, the plaque can burst releasing sticky globules into your blood stream which clogs & cuts off blood flow downstream.

A burst artery plaque upstream of your heart can cause a heart attack while one upstream of your brain can cause a stroke. Either way: very bad.

### Statins

Lipitor is the most well known example of a statin, at some point it was (and maybe still is) the best selling drug of all time. :moneybag:

In short: statins decrease the amount of LDL in your blood. 

More specifically: your body can manufacture cholesterol from carbohydrates and one of the steps of this process is performed by HMG-CoA reductase (HMGCR). Normally, HMGCR is suppressed by high LDL levels and this provides a nice feedback mechanism: too much LDL and HMGCR is suppressed so less cholesterol gets created & packaged into LDL, too little LDL and HMGCR is activated so more cholesterol gets created and packaged into LDL. But statins artificially deactivate HMGCR which deactivates cholesterol production & causes LDL levels to fall.

Cholesterol is an important building material though and inhibiting it's production can prevent muscles from being repaired properly leading to muscle pain or can interfere with brain maintenance leading to cognitive impairments.
...
This hypothesis is fairly intuitive: LDL is like an oil tanker that has a huge payload of sticky fat. If something goes wrong, it makes sense that it's cargo could spill and make a big mess. Meanwhile, HDL is like a tanker with a small payload. It's less likely to make a mess itself & it can even help clean up messes made from accidents involving LDL.

This theory is more commonly called the Lipid Hypothesis but I'm cheeky and like to refer to it as the Statin Hypothesis because it acts as a very effective sales campaign for statins.
...
> Too much *oxidized* LDL (called 'bad cholesterol') can lead to fatty deposits building up in the arteries which increases the risk of cardiovascular disease. Decreasing *oxidative stress* significantly reduces coronary heart disease.

A metaphor: LDL is a semi truck packed full of fuel & supplies and when it gets oxidized it's like the driver becomes drunk. Drunk drivers, especially when they're driving semis, are very dangerous.
...
The oxidized lipid hypothesis says "if we prevent drivers from getting drunk, then there won't be as many accidents" which is also true but lets us get at the root cause without causing so much collateral damage. In fact, oxidative stress causes collateral damage to other stuff, not just LDL, so lowering it will likely provide benefits beyond just decreasing risk of heart disease.

## Evidence

Cool story, Bo. So LDL is like a truck with a full payload or whatever but what *evidence* is there that LDL isn't a heart disease villain?!
